...
//       setBreakStartTime(new Date(data.break_start_time));
//       setBreakEndTime(null);
//     }
//   } catch (error) {
...
//       setBreakEndTime(new Date(data.break_end_time));
//     }
//   } catch (error) {
...
//                     onClick={isTimerRunning ? handleClockOut : handleClockIn}
//                   >
...
//                         })
//                           .format(attendanceStats.net_pay)
//                           .replace('NGN', '')
//                           .trim()}`}
//                   </h5>
//               </div>
