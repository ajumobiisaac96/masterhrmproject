...
import { faEye, faEyeSlash } from '@fortawesome/free-solid-svg-icons'; // Add the eye icons
          ...
          <form onSubmit={handleSubmit}>
            <div className="inputs">
              ...
              <div className="input-2" style={{ marginBottom: '20px' }}>
                ...
                {error.password && <div className="error-message">{error.password}</div>} {/* Show password error */}
              </div>
            </div>
            <button
              className="btn-general"
