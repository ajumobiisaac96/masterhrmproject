...
const AttendanceAndTracking = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch("https://proximahr.onrender.com/attendance-management/company-overview", {
          headers: {
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json",
          },
        ...
        const departmentResponse = await fetch("https://proximahr.onrender.com/attendance-management/departments-overview", {
          headers: {
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json",
          },
  ...
  const handleViewClick = async (departmentName) => {
    ...
    try {
      const url = `https://proximahr.onrender.com/attendance-management/employees-attendance?department=${departmentName}`;
