...
const Department = () => {
  ...
  const handleCardClick = async (departmentId) => {
    try {
      ...
      const departmentEmployees = data.data.filter(employee => employee.department === departmentName);
                ...
                filteredDepartments.map((dept, index) => (
                  <div key={index} className="card-3">
                    <div className="one-div">
                      <div><h1>{dept.name}</h1></div>
                      <div className="special-div">
                        <FontAwesomeIcon icon="fa-solid fa-pen-to-square" onClick={() => handleCardClick(dept.id)} style={{cursor:'pointer'}} />
                    ...
                    <hr className="new-hr" />
                    <div className="two-div">
                      <div><img src={test} alt="Department Head" className="My-profile" /></div>
                      <div><p>Department Head</p><h2>{dept.hod ? `${dept.hod.first_name} ${dept.hod.last_name}` : 'Not Assigned'}</h2></div>
                    </div>
                    <div className="three-div">
                      <div className="new-div">
                        <div><FontAwesomeIcon icon="fa-solid fa-users" className="new-div-icon" /></div>
                        <div><p>Team Members</p><h2>{dept.staff_size !== undefined ? dept.staff_size : 0}</h2></div>
                      </div>
                    </div>
                    <div className="four-div">
                      <div className="div-2-2">
